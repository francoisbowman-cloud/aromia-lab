...
- `/quiz` sigue como placeholder de Sprint 1 (esperando `COPY/quiz-questions.md` de Cowork) — no es un bug, es el estado esperado.
...
- `COPY/quiz-questions.md` sigue siendo la referencia pendiente para implementar `/quiz` de verdad.
