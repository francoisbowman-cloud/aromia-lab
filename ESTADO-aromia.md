...
Última actualización: 31 de julio de 2026 — por: Claude/Chat (scraper de precios Douglas/Primor activado en producción real tras el alta de Brey en Awin — decisión #94, cierra el bloqueo de #56/#61). Actualización previa el mismo día por Code: gap de `nicho_o_comercial` cerrado en API + admin + backfill real de los 12 Dior; fondo de mockups OVL parcialmente corregido a `--surface` según tema; fase futura de recortes sin fondo vía OMNI + rediseño con Design pautada, sin empezar — decisiones #91-93
