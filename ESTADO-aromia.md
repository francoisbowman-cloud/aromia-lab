...
**Inmediato: Fase 2 del sistema de imágenes — piloto visual de 5 perfumes**
(decisión #98, `docs/images/PILOT-PLAN.md`): Aventus, Baccarat Rouge 540,
Sauvage EDP, Black Opium EDP, Erba Pura. Secuencia: disparar
`delegations/COWORK-IMAGE-INVENTORY-BRIEF.md` y
`delegations/CHATGPT-VISUAL-AUDIT-BRIEF.md` sobre estos 5, generar derivados
de prueba con `scripts/images/optimize.mjs --dry-run`, revisión visual de
Brey, y solo con su aprobación explícita procesar de verdad y congelar el
estándar antes de escalar a los 50. Nada de esto arranca sin luz verde
explícita de Brey.
