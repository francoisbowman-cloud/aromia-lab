...
Última actualización: 31 de julio de 2026 — por: Code (gap de `nicho_o_comercial` cerrado en API + admin + backfill real de los 12 Dior; fondo de mockups OVL parcialmente corregido a `--surface` según tema; fase futura de recortes sin fondo vía OMNI + rediseño con Design pautada, sin empezar — decisiones #91-93)
...
5. **Brey** — darse de alta como afiliado en Awin para activar el scraper de Douglas/Primor (decisión #56); pasar credenciales de SendGrid y GA4.
