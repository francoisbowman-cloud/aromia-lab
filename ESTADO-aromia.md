...
Última actualización: 28 de julio de 2026 — por: Chat (barrido de pendientes sin bloqueo: "Imprimir PDF" del Magazine desactivado; el resto de la lista de la sección 13 depende de una decisión, credencial o asset de Brey)
...
2. **Code o Brey** — exponer `nicho_o_comercial` en `POST`/`PATCH /api/admin/perfumes` (gap encontrado al publicar, decisión #89) para que los perfumes nuevos no queden con ese campo vacío.
...
7. Dar seguimiento a los pendientes de la sección 13.
