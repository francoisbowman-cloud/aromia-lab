...
LOCAL_DESIGN_WORKFLOW: docs/operations/AROMIA_LOCAL_DESIGN_WORKFLOW.md — local = workshop; GitHub = source of truth; Railway = production. Root commands: local:infra, local:api, local:web, local:verify, local:infra:down.
