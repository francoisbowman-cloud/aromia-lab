  ...
  return (
    <main className="bg-[#fbf8f3] text-ink dark:bg-[#0f0c09]" aria-live="polite">
      ...
      <section className="mx-auto max-w-[1160px] px-6 py-16 lg:px-10 lg:py-24">
        <div className="mb-10">
          <p className="font-plex text-xs uppercase tracking-[.14em] text-gold-contrast">02 / Evolución</p>
      ...
      <section className="bg-[#f3eadc] dark:bg-[#15110d]">
        <div className="mx-auto max-w-[1160px] px-6 py-16 lg:px-10 lg:py-24">
          <div className="mb-10">
            <p className="font-plex text-xs uppercase tracking-[.14em] text-gold-contrast">03 / Contexto</p>
      ...
      <section id="precios" className="mx-auto max-w-[1160px] scroll-mt-24 px-6 py-16 lg:px-10 lg:py-24">
        <p className="font-plex text-xs uppercase tracking-[.14em] text-gold-contrast">04 / Compra informada</p>
      ...
      <section className="bg-[#fffdf8] dark:bg-[#100d0a]">
        <div className="mx-auto max-w-[1160px] px-6 py-16 lg:px-10 lg:py-24">
          <div className="mb-10">
            <p className="font-plex text-xs uppercase tracking-[.14em] text-gold-contrast">05 / Comunidad</p>
