    ...
    <article className="group relative flex min-w-0 flex-col py-2 sm:py-4 lg:py-6">
      ...
      >
        {layout === "monument" && index != null ? (
          <span aria-hidden="true" className="absolute -right-2 top-1/2 z-0 -translate-y-1/2 font-display text-[clamp(96px,16vw,220px)] leading-none tracking-[-.08em] text-ink/[0.028]">
