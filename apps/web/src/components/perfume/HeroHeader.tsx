  ...
  return (
    <section className="grid min-h-[70vh] overflow-hidden bg-[#fffdf8] dark:bg-[#100d0a] lg:grid-cols-[1.08fr_.92fr]">
      ...
      <div className="flex flex-col justify-between px-6 py-10 lg:px-12 lg:py-14">
        <div>
          <div className="flex items-center justify-between gap-4 font-plex text-xs uppercase tracking-[.14em] text-muted"><span>Ficha Aromia</span><span>{perfume.marca}</span></div>
          <p className="mt-10 min-h-3 font-plex text-xs uppercase tracking-[.15em] text-gold-contrast">{family ?? "Objeto olfativo"}</p>
