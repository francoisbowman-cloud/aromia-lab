...
export function HomeHero({ perfume }: { perfume?: Perfume }) {
  return (
    <section className="relative overflow-hidden border-b border-line bg-[#f7f5f0] dark:bg-[#0e1311]">
      <div className="mx-auto grid min-h-[650px] w-full max-w-[1520px] grid-cols-1 px-5 sm:px-8 lg:min-h-[760px] lg:grid-cols-[.92fr_1.08fr] lg:px-12">
        <div className="relative z-10 flex flex-col justify-between py-9 sm:py-11 lg:py-16">
          <p className="font-plex text-xs uppercase tracking-[.16em] text-[#5a6b54] dark:text-[#b8c5b3]">
            Aromia — perfume, contexto, criterio
          </p>

          <div className="py-9 sm:py-12 lg:py-20">
            <h1 className="max-w-[7.7ch] font-display text-[52px] font-medium leading-[.87] tracking-[-.055em] text-ink sm:text-[76px] lg:text-[106px]">
              El perfume se entiende mejor de cerca.
            </h1>
            <p className="mt-7 max-w-[38ch] font-sans text-[15px] leading-7 text-muted lg:text-base">
        ...
        <div className="relative min-h-[460px] sm:min-h-[540px] lg:min-h-0">
          <div aria-hidden="true" className="absolute inset-x-[8%] top-[8%] h-[76%] rounded-[50%] bg-[#d9c8b1]/40 blur-[90px] dark:bg-[#4a1f24]/20" />
          {perfume ? (
            <div className="absolute inset-0 flex items-start justify-center pt-4 sm:items-center sm:pt-0 lg:justify-end">
              <div className="relative h-[94%] w-[94%] max-w-[720px] transition-transform duration-700 ease-out hover:-translate-y-1 sm:h-[86%] sm:w-[90%] lg:h-[84%] lg:w-[94%]">
                <ProductImage
                  slug={perfume.slug}
